...
TIER1 = ["Country", "Gender", "Age", "Tobacco_Use", "Alcohol_Use",
         "Socioeconomic_Status", "HPV_Related"]
...
def main() -> None:
    ...
    print("TIER 2 (sintomas clínicos): AUSENTES neste dataset "
    ...
    discrete_mask = [c in cat_cols or X_enc[c].dropna().nunique() <= 2
    ...
    ranking = (
        ...
        .assign(tier=lambda d: d["feature"].apply(
    ...
    print("\n--- Age (buckets) ---")
    print(pd.crosstab(df_t["age_bucket"], df_t["high_risk"],
    ...
    for c in ["Country", "Gender", "Tobacco_Use", "Alcohol_Use",
              "Socioeconomic_Status", "HPV_Related"]:
    ...
    print(f"  {'Age':22s} point-biserial r={r:+.5f} p={p_age:.4f}  "
    ...
    print(f"Maior MI entre TIER 3 (vazamento): "
