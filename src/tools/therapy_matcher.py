        ...
        if rl_upper == "HIGH":
            options = [
                TherapyOption(
                    ...
                    evidence_level="I",
                    line=1,
                    contraindications=["Pacientes clinicamente inaptos para cirurgia de grande porte", "Doença metastática à distância generalizada"]
                ),
                TherapyOption(
                    ...
                    evidence_level="I",
                    line=1,
                    contraindications=["Disfunção renal severa (ClCr < 50 ml/min)", "Neuropatia preexistente severa"]
                ),
                TherapyOption(
                    ...
                    evidence_level="I",
                    line=2,
                    contraindications=["Doença autoimune ativa não controlada", "Uso crônico de corticosteroides em altas doses"]
                )
            ]
            stage_estimate = "Moderado/Avançado (Estágio III-IV)"
            ...
            options = [
                TherapyOption(
                    ...
                    evidence_level="I",
                    line=1,
                    contraindications=["Lesões extensas irressecáveis com invasão profunda de estruturas vitais"]
                ),
                TherapyOption(
                    ...
                    evidence_level="II",
                    line=1,
                    contraindications=["Exposição óssea mandibular preexistente", "Irradiação prévia da mesma área"]
                ),
                TherapyOption(
                    ...
                    evidence_level="II",
                    line=2,
                    contraindications=["Lesões com displasia grave confirmada", "Não adesão do paciente ao protocolo de retorno"]
                )
            ]
            stage_estimate = "Inicial/Intermediário (Estágio I-II)"
            ...
            options = [
                TherapyOption(
                    ...
                    evidence_level="II",
                    line=1,
                    contraindications=["Presença de sintomatologia dolorosa progressiva", "Surgimento de linfonodopatia cervical"]
                ),
                TherapyOption(
