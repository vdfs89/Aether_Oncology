...
class EscalationPolicy:
    ...
    def evaluate(self, judgement: ClinicalJudgement) -> ClinicalJudgement:
        ...
        if judgement.hallucination_risk == "HIGH" or judgement.evidence_strength == "LOW" or judgement.contradictions:
        ...
        if judgement.requires_physician_review and judgement.escalation_level == "HARD_STOP":
            judgement.approved = False
