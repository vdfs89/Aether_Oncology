...
const INTENDED: [string, string][] = [
  ...
  ["Uso primário", "CDSS para triagem de risco — Estágio Inicial (Early) vs. Avançado (Moderate/Late)."],
  ...
  ["Fora de escopo", "não diagnostica autonomamente, não substitui biópsia/histologia, não prescreve terapias."],
]
